...
export class AuthGuard implements CanActivate {
   ...
   canActivate(
      ...
      // this one is tough. We need to return the login state, so if there is an authenticated user or not.
      ...
      // take one has to be here because we only whant the value once! otherwise this can lead to side effects.
      return this.authService.user.pipe(
         ...
         map(user => {
            ...
            // this allows rerouting from whithin the guard. this is a relatively new feature.
